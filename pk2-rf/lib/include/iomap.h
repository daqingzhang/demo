...
/* 32KB SRAM for Instruction Space */
#define CONFIG_SRAM0_BASE 0x00000000
#define CONFIG_SRAM0_SIZE (0x8000) /* 32KB */
#define CONFIG_SRAM0_END  (CONFIG_SRAM0_BASE + CONFIG_SRAM0_SIZE)

/* 16KB SRAM for Data Space */
#define CONFIG_SRAM1_BASE CONFIG_SRAM0_END
#define CONFIG_SRAM1_SIZE (0x4000) /* 16KB */
...
/* DEBUG UNIT BASE ADDR */
#define RDA_DBUG_BASE	0x00020000
